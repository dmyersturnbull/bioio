...
public class PedigreeBuilder implements ObjectBuilder<Pedigree> {
	 ...
	 *
	 * Note that the sex of a parent must be correct: if A is the mother of B, then A must have {@link Sex} FEMALE (cannot be MALE or UNKNOWN).
	 *
	...
	/**
	 * Builds the {@link Pedigree}. After this method is called, calls to
