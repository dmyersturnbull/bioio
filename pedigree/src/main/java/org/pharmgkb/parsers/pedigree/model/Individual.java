...
/**
 * A member of a {@link Family}.
 * Associated with an {@link #getId() Id} that is unique for this {@link Pedigree}.
 *
 * Implements {@link Subtree} for search and traversals using <em>this node</em> as root.
